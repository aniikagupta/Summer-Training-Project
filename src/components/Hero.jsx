...
const Hero = () => {
  return (
    // no extra side padding here, the page wrapper in App.jsx already has it
...
/>
        ...
        {/* Hero Content */}
        <div className="absolute inset-0 flex items-center">
          <div className="text-white px-6 sm:px-12 md:px-16 max-w-xl">
            ...
            {/* Link instead of a plain button so it actually goes somewhere */}
            <Link
              to="/collection"
              className="inline-block bg-white text-black px-8 py-3 text-sm
              tracking-wide hover:bg-black hover:text-white
              transition duration-300"
            >
              SHOP NOW
